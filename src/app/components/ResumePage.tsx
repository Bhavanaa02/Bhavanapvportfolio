...
<FadeSection delay={0.3}>
  <div className={SECTION}>
    <h2 className={SECTION_TITLE} style={{ color: "#fff", borderColor: "rgba(255,255,255,0.1)" }}>
      Professional Summary
    </h2>
    <p style={{ color: "rgba(255,255,255,0.6)", lineHeight: "1.85" }}>
      Cybersecurity graduate with hands-on experience in Linux administration,
      networking, web technologies, and technical support. Completed a 7-month
      internship at Albus Security LLP and built practical projects involving
      infrastructure monitoring, troubleshooting workflows, WordPress hosting,
      and security operations. Passionate about problem-solving, system
      administration, and helping users resolve technical issues through
  ...
  <div className={SECTION}>
    ...
    <div className="space-y-5">
      {[
        {
          degree:
            "Bachelor of Computer Applications (Honours) - Cybersecurity",
