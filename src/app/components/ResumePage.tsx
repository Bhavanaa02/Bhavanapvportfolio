            ...
            <FadeSection delay={0.3}>
              <div className={SECTION}>
                ...
                <p style={{ color: "rgba(255,255,255,0.6)", lineHeight: "1.85" }}>
                  Cybersecurity graduate with hands-on experience in Security Operations, threat detection, and infrastructure monitoring. Skilled in building practical security-focused systems including intrusion detection, insider threat analysis, DoS attack simulation, and blockchain-based security applications. Passionate about cyber defense, technical analysis, and developing operational security workflows that bridge theory with real-world application.
                </p>
              </div>
            </FadeSection>
                  ...
                  {[
                    {
                      ...
                      label: "Networking",
                      items: ["Network Protocols, TCP/IP Stack", "LAN/WAN Switching, Routing", "Firewall Configuration, VPN", "Packet Analysis, Wireshark"],
                    },
                    {
                      icon: <Shield className="w-4 h-4" style={{ color: "#a78bfa" }} />,
                      label: "Security Assessment",
                      items: ["SAST, DAST, VAPT", "OWASP Top 10, MITRE ATT&CK", "Nmap / Nessus / Burp Suite", "Vulnerability Assessment"],
                    },
                    {
                      icon: <Cpu className="w-4 h-4" style={{ color: "#34d399" }} />,
                      label: "Operating Systems",
                      items: ["Ubuntu, CentOS, Kali Linux", "Windows Server Administration", "VM Configuration (VirtualBox/VMware)", "Bash & Shell Scripting"],
                    },
                    {
                      icon: <Cloud className="w-4 h-4" style={{ color: "#38bdf8" }} />,
                      label: "Cloud / DevOps Technologies",
                      items: ["Docker, CI/CD Pipelines", "AWS Fundamentals", "Web Server Configuration", "Python, Bash"],
                    },
                    {
                      icon: <Terminal className="w-4 h-4" style={{ color: "#f472b6" }} />,
                      label: "Security & Testing Tools",
                      items: ["Snyk, BloodHound, Varacode", "Burp Suite, Tenable.io, Metasploit", "OWASP ZAP, Netparser, Postman", "Wireshark, Nmap, gobuster"],
                    },
                    {
                      icon: <Code className="w-4 h-4" style={{ color: "#fb923c" }} />,
                      label: "Development",
                      items: ["Python, Bash Scripting", "Solidity (Blockchain)", "React, JavaScript", "SIEM Platform Usage"],
                    },
                  ].map((cat) => (
            ...
            <FadeSection delay={0.4}>
              <div className={SECTION}>
                ...
                <div className="space-y-8">
                  {[
                    {
                      role: "Security Operations Analyst (Intern)",
                      org: "Cybersecurity Training Program",
                      period: "2023 – Present",
                      bullets: [
                        "Monitored SIEM dashboards for real-time threat detection and alert triage.",
                        "Assisted in incident response workflows and log analysis using Splunk/ELK.",
                        "Developed scripts to automate repetitive SOC tasks, reducing response time.",
                        "Documented security incidents, findings, and mitigation recommendations.",
                      ],
                    },
                    {
                      role: "Cybersecurity Research Project Lead",
                      org: "Academic Institution",
                      period: "2022 – 2023",
                      bullets: [
                        "Led development of InsiderThreat Analyzer — behavioral analytics system for anomaly detection.",
                        "Designed and implemented Slowloris DoS simulation for educational security research.",
                        "Built VoteChain, a blockchain-based voting system using Ethereum and Solidity.",
                        "Presented research findings to faculty and peer review committees.",
                      ],
                    },
                    {
                      role: "Technical Infrastructure Monitor",
                      org: "College IT Department",
                      period: "2021 – 2022",
                      bullets: [
                        "Configured and maintained network infrastructure monitoring tools.",
                        "Performed vulnerability scans and reported findings to department leads.",
                        "Managed Linux-based servers and assisted with patch management.",
                      ],
                    },
                  ].map((exp, i) => (
                  ...
                  {[
                    {
                      ...
                      inst: "University / College Name",
                      period: "2020 – 2024",
                    },
                    {
                      degree: "Higher Secondary — Science (PCM + Computer Science)",
                      inst: "School Name",
                      period: "2018 – 2020",
                    },
                  ].map((ed, i) => (
                  ...
                  {[
                    {
                      ...
                      desc: "Real-time security monitoring dashboard with threat detection, log ingestion, alert triage, and incident management. Integrates Elasticsearch for log storage and visualizes security events with customizable dashboards.",
                      tags: ["Python", "React", "Elasticsearch", "SIEM"],
                    },
                    {
                      name: "Insider Threat Analyzer",
                      desc: "Behavioral analytics system that detects anomalous insider activity using pattern recognition, user behavior baselining, and automated alerting. Built to simulate real-world SOC use cases.",
                      tags: ["Python", "ML", "UEBA", "Pandas"],
                    },
                    {
                      name: "Slowloris DoS Attack Automation",
                      desc: "Educational simulation of Slowloris HTTP DoS attacks with configurable thread counts, connection rates, and timeout parameters. Designed for controlled lab environments and security research.",
